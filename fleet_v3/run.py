...
def run(opts):
    ...
    model = model_class(
        ...
        spatial_encoder=getattr(opts, 'spatial_encoder', False),
        spatial_window=getattr(opts, 'spatial_window', None),
        spatial_tau=getattr(opts, 'spatial_tau', None),
        spatial_type=getattr(opts, 'spatial_type', 'dual'),
        spatial_bias_mode=getattr(opts, 'spatial_bias_mode', 'min'),
        spatial_alpha=getattr(opts, 'spatial_alpha', 0.5)
    ).to(opts.device)
